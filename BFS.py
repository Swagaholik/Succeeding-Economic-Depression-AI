...
# The numbered STEP comments correspond
 to the algorithm steps given in the slides of
 the "Basic Search Algorithms" lecture.
'''
...
print("\nWelcome to BFS (Breadth-First Search)")
COUNT = None
BACKLINKS = {}
...
def BFS(initial_state):
  global COUNT, BACKLINKS, MAX_OPEN_LENGTH, CLOSED
...
#         If S is a goal state, output its description
    ...
    CLOSED.append(S)
    # print("CLOSED: ",end="")
    # for s in CLOSED: print(str(s)+"; ",end="")
...
# STEP 5. Delete from L any members of OPEN that occur on L.
    ...
    # Set the back-links for those successors that remain
    for s2 in L:
      BACKLINKS[s2] = S
...
def backtrace(S):
  ...
  while S:
    ...
    S = BACKLINKS[S]
  path.reverse()
  print("Nodes on the solution path: ")
  for s in path:
    print(s)
  return path    
